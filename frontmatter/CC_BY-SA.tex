...
Questo documento, intitolato \BookTitle,
...
il riconoscimento dell'autore originale e la preservazione della natura open
...
\begin{itemize}
  ...
  dell'opera, citando l'autore originale, il titolo del documento e la fonte.
  L'attribuzione deve essere effettuata in modo ragionevole e non tale da suggerire
  che l'autore originale approvi l'uso o le modifiche apportate.
...
esplicite o implicite. In particolare, l'autore non garantisce l'accuratezza,
la completezza o l'assenza di errori nel contenuto del documento e declina
