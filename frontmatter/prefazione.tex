...
Queste dispense sono nate come appunti personali per il corso di \BookTitle \space tenuto presso il Dipartimento di Matematica e Informatica dell'Universit\`a di Catania tenuto dal Prof. Marco Ruggieri nell'anno accademico 2025/2026. L'obiettivo principale di questo materiale è stato fornire una risorsa personale di studio sulla parte teorica del corso, raggruppando concetti chiave, definizioni, teoremi, immagini ed esempi in unico documento. 
...
\centering
\url{https://github.com/emanuelegaliano/Fisica}
\end{minipage}
\end{center}

In particolare, all'interno del repository GitHub sono presenti il codice open-source dei sorgenti \LaTeX{} utilizzati per generare queste dispense, oltre a tutti i file di supporto come immagini, bibliografia e altro materiale utile.